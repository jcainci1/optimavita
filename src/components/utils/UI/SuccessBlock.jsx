...
export default function SuccessBlock({ title, message, onClose }) {
  ...
  return (
    <div ref={successMessageRef} className={classes.successBlockContainer}>
      <div className={classes.successBlock}>
        <div className={classes.successBlockClose} onClick={onClose}>
